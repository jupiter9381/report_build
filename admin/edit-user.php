<?php 
	...
	include("functions/fn_edituser.php");
	$title = "Edit User";
	$page = "edituser";
?>
<!doctype html>
	                                    			...
	                                    			<div class="row">
	                                    				<div class="col-sm-8 col-12">
	                                    					<div class="form-group row">
	                                    						...
	                                    						<div class="col-md-9">
	                                    							<div class="controls">
	                                    								<input type="text" class="form-control square" name="name" id="name" data-validation-required-message="This Name field is required" required value="<?php echo htmlentities($result->name);?>">
	                                    							</div>
	                                    						</div>
	                                    					</div>
	                                    				</div>
	                                    			...
	                                    			<div class="row">
	                                    				<div class="col-sm-8 col-12">
	                                    					<div class="form-group row">
	                                    						...
	                                    						<div class="col-md-9">
	                                    							<div class="controls">
	                                    								<input type="email" class="form-control square" name="email" id="email" data-validation-required-message="This Email field is required" required value="<?php echo htmlentities($result->email);?>">
	                                    							</div>
	                                    						</div>
	                                    					</div>
	                                    				</div>
	                                    						...
	                                    						<div class="col-md-9">
	                                    							<div class="controls">
	                                    								<select class="form-control square" name="level" id="level" data-validation-required-message="This level field is required" required>
	                                    									<option></option>
	                                    									<option value="1" <?php if($result->level == 1) echo 'selected';?>>Leve1</option>
	                                    									<option value="2" <?php if($result->level == 2) echo 'selected';?>>Leve2</option>
	                                    									<option value="3" <?php if($result->level == 3) echo 'selected';?>>Leve3</option>
	                                    								</select>
	                                    							</div>
	                                    						</div>
	                                    					</div>
	                                    						...
	                                    						<div class="col-md-9">
	                                    							<div class="controls">
	                                    								<select class="form-control square" name="role" id="role" data-validation-required-message="This role field is required" required>
												                            ...
												                            <option value="Viewer" <?php if($result->role == 'Viewer') echo 'selected';?>>Viewer</option>
	                                    								</select>
	                                    							</div>
	                                    						</div>
	                                    					</div>
